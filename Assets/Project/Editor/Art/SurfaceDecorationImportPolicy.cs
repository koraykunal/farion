...
{
    internal sealed class SurfaceDecorationImportPolicy : AssetPostprocessor
    {
        ...
        {
            if (!assetPath.StartsWith(FarionAssetPaths.SurfaceDecorationModelFolder, StringComparison.Ordinal))
            {
                return;
            }
        ...
        {
            if (!assetPath.StartsWith(FarionAssetPaths.SurfaceDecorationTextureFolder, StringComparison.Ordinal))
            {
                return;
            }
