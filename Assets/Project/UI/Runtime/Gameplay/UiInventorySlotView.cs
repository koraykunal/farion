...
namespace Farion.UI.Gameplay
{
    ...
    public sealed class UiInventorySlotView :
        Selectable,
        ISubmitHandler,
        IPointerClickHandler
    {
        ...
        public event Action<UiInventorySlotView> Focused;
        public event Action<UiInventorySlotView> ContextRequested;
        public event Action<UiInventorySlotView> PrimaryClicked;
