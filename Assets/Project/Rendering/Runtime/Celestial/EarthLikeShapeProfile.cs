...
{
    [CreateAssetMenu(menuName = "Farion/Rendering/Earth-Like Shape Profile", fileName = "SO_EarthLikeShapeProfile")]
    public sealed class EarthLikeShapeProfile : CelestialShapeProfile
    {
        [Header("Seed")]
